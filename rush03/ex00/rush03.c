...
/*   Updated: 2024/04/21 17:41:45 by mhabbal          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (max_rows - rows == max_rows || max_rows - rows == 1)
	{
		if (max_cols - cols == max_cols)
			ft_putchar("A");
		else if (max_cols - cols == 1)
			ft_putchar("C");
		else
			ft_putchar("B");
	}
	else if (max_cols - cols == max_cols || max_cols - cols == 1)
		ft_putchar("B");
	else
		ft_putchar(" ");
}
